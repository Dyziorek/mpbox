...
using EventSeverityClass = Enum<EventSeverity, EventSeverity_names, 5>;
inline std::ostream& operator<<(std::ostream& os, EventSeverity t);
...
using EventClass = Enum<Event, Event_names, 15>;
inline std::ostream& operator<<(std::ostream& os, Event t);
