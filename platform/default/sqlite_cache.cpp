    ...
    try {
        ...
        if (getStmt->run()) {
            ...
            if (getStmt->get<int>(5)) { // == compressed
                response->data = util::decompressgzip(response->data);
            }
