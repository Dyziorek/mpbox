...
//
//#pragma comment(linker, "/EXPORT:_zlibVersion=_zlibVersion@0")
//#pragma comment(linker, "/EXPORT:_deflate=_deflate@8")
//#pragma comment(linker, "/EXPORT:_deflateEnd=_deflateEnd@4")
//#pragma comment(linker, "/EXPORT:_inflate=_inflate@8")
//#pragma comment(linker, "/EXPORT:_inflateEnd=_inflateEnd@4")
//#pragma comment(linker, "/EXPORT:_deflateInit_=_deflateInit_@16")
//#pragma comment(linker, "/EXPORT:_inflateInit_=_inflateInit_@12")
...
std::string decompressgzip(const std::string &raw) {
	z_stream inflate_stream;
	memset(&inflate_stream, 0, sizeof(inflate_stream));
