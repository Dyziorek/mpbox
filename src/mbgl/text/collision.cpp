...
Collision::Collision(float zoom_, float tileExtent, float tileSize, float placementDepth)
    ...
    left.placementRange = {{ (float)(2.0f * M_PI), 0.0f }};
    ...
    top.placementRange = {{ (float)(2.0f * M_PI), 0.0f }};
    ...
    bottom.placementRange = {{ (float)(2.0f * M_PI), 0.0f }};
    ...
    right.placementRange = {{ (float)(2.0f * M_PI), 0.0f }};
